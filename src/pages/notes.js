...
/**
 * Filters the design note items, anything that contains "design" using *
 *
 */
...
/**
 * Filters the stories notes, anything that contains "stories" using *
 *
 */
const filterClickStories = () => {
    let StoriesItems = document.querySelectorAll('[data-filter*="Stories"]')

    clearFilterItemsActive();
    document.querySelector('#FilterItemStories').classList.add('active');
  ...
  <React.Fragment>
    ...
    <Row>
        <Column>
            ...
            <HeaderSubtitle>My notes.</HeaderSubtitle>
        </Column>
    ...
    <Row>
        ...
        <FilterContainer id="FilterContainer">
            ...
            <h5 onClick={filterClickStories} id="FilterItemStories">STORIES</h5>
        </FilterContainer>
